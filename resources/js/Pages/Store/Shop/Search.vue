<template>
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="relative isolate overflow-hidden bg-white px-6 pb-10 text-center sm:px-16 sm:shadow-sm">
            ...
            <form>
                <label
                    ...
                    for="search-bar">
                    <input id="search-bar" placeholder="Escribe para buscar" name="q"
                        class="px-6 py-2 w-full rounded-md flex-1 outline-none bg-white" :value="searchTerm"
            ...
            <p class="mt-2 cursor-pointer underline text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"
