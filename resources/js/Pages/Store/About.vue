          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="mt-10 lg:mt-0">
              ...
              <a
                ...
                class="inline-flex items-center justify-center py-3 text-base font-medium text-center lightblue-text border border-transparent rounded-md bg-white"
              >
                THR | CORPORATION
              </a>
            </div>
